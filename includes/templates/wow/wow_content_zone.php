...
<div class="content-bot">
    ...
    if($zone_info['expansion'] > EXPANSION_CLASSIC) {
		...
		<a href="/%swow/game/patch-notes/%s" class="color-ex%d">%s %s%s</a></span>', $zone_info['expansion'], WoW::GetWoWPath(), null, $zone_info['expansion'], WoW_Locale::GetString('template_zone_expansion_required'), WoW_Locale::GetString('template_expansion_' . $zone_info['expansion']),
